 ...
 */
export function bitSlice(a, bstart, bend) {
 ...
 */
export function extract(a, bstart, blength) {
 ...
 */
export function partial(len, x, _end) {
  if (len === 32) {
    return x
  }
